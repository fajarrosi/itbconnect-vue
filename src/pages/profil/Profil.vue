    ...
    <q-page class="q-pb-lg">
        ...
        <div v-if="valid">
            ...
            <div class="row q-mx-md justify-between items-center">
                ...
                <div class="row">
                    <q-btn round flat dense type="a" target="_blank" :href="'https://www.linkedin.com/in/'+databio.linkedin" v-if="databio.linkedin">
                        <img src="images/linkedin-bluee.png" alt="linkedin">
                    </q-btn>
                    <q-btn round flat dense type="a" target="_blank" :href="'https://www.instagram.com/'+databio.ig" v-if="databio.ig">
                        <img src="images/instagram-bluee.png" alt="ig">
                    </q-btn>
                    <q-btn round flat dense type="a" target="_blank" :href="'https://www.facebook.com/'+databio.fb" v-if="databio.fb">
                        <img src="images/facebook-bluee.png" alt="fb">
                    </q-btn>
                    <q-btn round flat dense type="a" target="_blank" :href="'https://www.twitter.com/'+databio.twit" v-if="databio.twit">
