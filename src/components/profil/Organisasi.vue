...
font-size: 12px;padding-top:0;" no-caps @click="ubah" v-if="dataorganisasi[0].user_id === userid">
                <div>Ubah</div>
                <q-icon name="edit" size="15px"/>
            </q-btn>
        </div>
            <ul style="padding-left:0;list-style:none;" class="q-my-none profil-color">
